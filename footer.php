    ...
    <?php wp_footer(); ?><footer style="padding-top:20px;">
      <div id="olefooter">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-2 col-sm-6 col-6">
                <?php if (is_active_sidebar('footer_4')) dynamic_sidebar('footer_4'); ?>
            </div>
            <div class="col-md-2 col-sm-6 col-6">
                <?php if (is_active_sidebar('footer_5')) dynamic_sidebar('footer_5'); ?>
            </div>
          </div>
          
          <div class="row">
            <div class="col-md-12 col-sm-12 col-12 footcc">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/creative-commons.png" alt="Creative Commons" />
                Unless explicitly mentioned, all the contents on this website are licensed under <a href='https://creativecommons.org/licenses/by-nc-nd/3.0/' target='_blank'><b>Creative Commons</b></a>
            </div>
          </div>
        </div>
      </div>
